...
public class Project052
{
	...
	{
		var digitOfString1 = new int[10];
		var digitOfString2 = new int[10];
		var digitOfString3 = new int[10];
		var digitOfString4 = new int[10];
		var digitOfString5 = new int[10];
		var digitOfString6 = new int[10];
	...
	public static void main(String[] args)
	{
		...
		while (true)
		{
			...
			var s2 = String.valueOf(n * 2);
			var s3 = String.valueOf(n * 3);
			var s4 = String.valueOf(n * 4);
			var s5 = String.valueOf(n * 5);
			var s6 = String.valueOf(n * 6);
